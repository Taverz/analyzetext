...
class _CropPageState extends State<CropPage> with SingleTickerProviderStateMixin{
  ...
  // String baiduApi = "https://aip.baidubce.com/oauth/2.0/token?";
  String baiduRestApi = "https://api.ocr.ads-soft.ru/recognition";
  ...
  Future<void> _capturePng() async {
    ...
    _postImageYandex( frame, base64Image); //Uint8List.fromList(byteList)
  ...
  _postImageYandex(frame, String base64Image) async{
    ...
    // String accessToken =  response.data['access_token'].toString();
    String IAM_TOKEN = 
    "4b25e70324ce4b6db4c0dcd610da77f2";
    ...
    String ocrUrl = "https://api.ocr.ads-soft.ru/recognition";
    // String ocrUrl = baiduRestApi+"access_token="+accessToken;
    FormData formData = FormData.fromMap({
       "token":IAM_TOKEN,
       "real_ip":123,
        "image":base64Image  //base64Image.toList()
        // MultipartFile.fromBytes(base64Image)
            // await MultipartFile.fromFile(file.path, filename:fileName),
    });
    //  FormData formData2 = FormData.fromMap({
    //   "name_image": "scanImage123",
    ...
    // {
    //   "token":IAM_TOKEN,
    //   "image":formData, //_requestYandex(base64Image),
    //   "real_ip":123
    // }
    ,
    //{"image":base64Image}, 
